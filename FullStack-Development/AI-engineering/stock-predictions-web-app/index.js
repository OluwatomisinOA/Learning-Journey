...
async function fetchReport(data) {
    ...
    const messages = [
        {
            role: 'system',
            content: 'You are a trading guru. Given data on share prices over the past 3 days, write a report of no more than 150 words describing the stocks performance and recommending whther to buy, hold or sell. Use the examples provided between ### for the style of your response'
        },
        {
            role: 'user',
            content: `${data}
